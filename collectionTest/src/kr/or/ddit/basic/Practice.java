...
//				public prodVO selectByProdId(String prodId){}
//			
...
//				public List<prodVO> selectProdIdName(){}
//				
...
//				public List<memberVO> selectMemberIdName(){}
//				
...
//			public List<ziptbVO> selectByZip(String dong){};
//			
//			
//			
...
//			public List<prodVO> prodInfo(String id){};
//			
//			
//			9) 상품테이블의 거래처코드를 중복되지 않게 검색 
//			String sql = "SELECT DISTINCT PROD_BUYER FROM PROD";
//			public List<Map<String,Object>> buyerDistinct(){};
//			public List<prodVO> buyerDistinct(){};
//			
//			
...
//			public List<prodVO> selectByProdlgu(){}			
//			
...
//				public boardVO selectAnswerBySEQ(){}
